...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Register New Patient</h1>
            <p class="text-sm text-gray-500">Add patient information to your records</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('patients.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="medical_notes" rows="3"
                          placeholder="Allergies, medical history, conditions..."
        ...
        <div class="flex items-center justify-end gap-3">
            <a href="{{ route('patients.index') }}" class="px-5 py-2.5 rounded-xl border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition">Cancel</a>
